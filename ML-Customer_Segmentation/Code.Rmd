...
Ini adalah Machine Learning yang digunakan untuk mencari segmen dari kostumer berdasarkan kriteria-kriteria yang ada
...
```
Terlihat bahwa data yang baru saja kita masukkan di prediksi oleh model termasuk ke dalam cluster ke 2
